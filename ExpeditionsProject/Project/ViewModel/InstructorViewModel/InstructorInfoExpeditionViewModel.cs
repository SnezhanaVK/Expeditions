...
{
    internal class InstructorInfoExpeditionViewModel : ViewModelBase
    {
        ...
        public InstructorInfoExpeditionViewModel(ViewModelStore viewModelStore, DataWork dataWork, int idClient, int idExpedition)
        {
        ...
        public InstructorInfoExpeditionViewModel(ClientInfoExpeditionModel _model)
        {
            model = _model;
        }
