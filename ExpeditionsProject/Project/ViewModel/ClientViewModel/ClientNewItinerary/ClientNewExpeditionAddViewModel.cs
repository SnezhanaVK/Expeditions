...
{
    public class ClientNewExpeditionAddViewModel : ViewModelBase
    {
        ...
        public ICommand GoStartMenuClient { get; set; }
        public ICommand SelectExpeditionCommand { get; private set; }
        public ICommand AddClientToExpedition { get; set; }
        


        public ClientNewExpeditionAddViewModel(ViewModelStore viewModelStore, DataWork dataWork, int idClient, int idExpedition)
        {
            _viewModelStore = viewModelStore;
            _dataWork = dataWork;
            ID_client = idClient;
            ID_expedition = idExpedition;
            GoStartMenuClient = new NavigateCommand(_viewModelStore, () => { return new StartPanelClientViewModel(_viewModelStore, dataWork, idClient); });
            AddClientToExpedition = new AddClientToExpeditionCommand(this, _dataWork);
            Back = new NavigateCommand(_viewModelStore, () => { return new ClientNewExpeditionViewModel(_viewModelStore, dataWork, idClient, idExpedition); });
        ...
        public ClientNewExpeditionAddViewModel(ClientInfoExpeditionModel _model)
        {
            model = _model;
        }
